;(function($, window, document,undefined) {
    ...
    Drag.prototype = {
        run: function() {
					...
					var o_x = this.options.o_x;//==>新添加---范留山
					var o_y = this.options.o_y;//==>新添加---范留山
...
//						element.addClass('on');
					...
					$(document).mouseup(function(e){fun.dragEnd(parseInt(element.css('left')),parseInt(element.css('top')));isDown = false;});
